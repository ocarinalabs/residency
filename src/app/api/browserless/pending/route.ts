...
export async function GET() {
  try {
    console.log("[Browserless] Fetching pending visitors...");
    ...
    // Scrape pending visitors
    const visitors = await nuveqScraper.scrapeVisitors("pending");
    ...
    console.error("[Browserless] Error fetching pending visitors:", error);
