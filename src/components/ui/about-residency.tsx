        ...
        <BlurFade delay={ANIMATION_DELAY}>
          <div className="space-y-8">
            ...
            <p className="text-lg md:text-xl leading-relaxed">
              An experimental AI residency connecting Malaysia&apos;s most{" "}
              <em>ambitious</em> builders.
            </p>

            <p className="text-lg md:text-xl leading-relaxed">
              Based at the 500 Social House, we offer premium co-working space
              to work with equally ambitious peers shipping AI products that{" "}
              <em>matter</em>.
            </p>

            <p className="text-lg md:text-xl leading-relaxed">
              Build <em>faster</em>. Ship <em>daily</em>. Grow{" "}
              <em>exponentially</em>. Surrounded by founders and hackers who
              push you to level up every single day.
            </p>

            <p className="text-lg md:text-xl leading-relaxed">
              Share wins, debug together, create content, and build in public
              alongside hackers and founders who are reshaping Malaysia&apos;s
